...
# SECRET_KEY = 'django-insecure-_-e*!j$mequ!a#d-lyrpdd3p2g6l+f^m))f7@4kwsy7%kahhql'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'kite343gb$default',
        'USER': 'kite343gb',
        'PASSWORD': os.getenv('MYSQL_PASSWORD'),
        'HOST': 'kite343gb.mysql.pythonanywhere-services.com',
        'OPTIONS': {
